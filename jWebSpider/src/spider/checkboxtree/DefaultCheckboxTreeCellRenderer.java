 ...
 * 02110-1301, USA
 */
package spider.checkboxtree;

import spider.checkboxtree.QuadristateButtonModel.State;
...
public class DefaultCheckboxTreeCellRenderer extends JPanel implements CheckboxTreeCellRenderer {
	...
	this.setLayout(new FlowLayout(FlowLayout.LEFT, 0, -3));//为了兼容JTattoo主题皮肤，此处调节树节点向上偏移3像素，getPreferredSize()方法内return语句中调节节点高度减去6像素。
    ...
    // }
     ...
     return new Dimension(d_check.width + d_label.width, (d_check.height <
         d_label.height ? d_label.height : d_check.height)-6);//为了兼容JTattoo主题皮肤，此处调节树节点高度减去6像素，DefaultCheckboxTreeCellRenderer()方法内setLayout语句中调节节点向上偏移3像素。
     }
